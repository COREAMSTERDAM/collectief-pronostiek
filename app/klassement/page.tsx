        ...
        <section className="mb-8">
          {biggestRiser ? (
            <Link
              ...
              className="group mx-auto block max-w-xl rounded-3xl border border-emerald-300/20 bg-gradient-to-br from-emerald-500/15 via-slate-950/90 to-emerald-500/10 p-5 shadow-xl shadow-emerald-950/10 transition duration-200 hover:-translate-y-0.5 hover:border-emerald-300/40"
